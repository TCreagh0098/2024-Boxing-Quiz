...
for attempt in stats_output["recent_attempts"]:
    print(f"Questions Asked: {attempt['questions_asked']}, Correct Answers: {attempt['correct_answers']}")

print(f"Average Correct Percentage: {stats_output['average_correct_percentage']}%")
print(f"Total Correct Answers: {stats_output['total_correct_answers']}")
print(f"Total Questions Asked: {stats_output['total_questions_asked']}")
